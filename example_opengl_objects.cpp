...
void TestOpenGLObjects()
{
  ...
  gui3d::nFigure("Demo of MRPT's OpenGL objects", 1080, 720);
  gui3d::CDisplayWindow3DPtr win = gui3d::instance();
  ...
  {  // (range,bearing) -> (x,y)
...

    {
      ...
      obj->setName("CEllipsoidRangeBearing2D");
  ...
  // CPointCloudColoured
  {
    ...
    obj->setLocation(off_x, 0, 0);
    obj->setName("CPointCloudColoured");
    theScene->insert(obj);
